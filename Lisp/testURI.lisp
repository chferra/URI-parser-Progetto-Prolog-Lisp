...
(load "C:\\Users\\Chris\\Desktop\\uri-parse.lisp")
...
(defmacro test (s r)
`(let* ((u (uri-parse ,s)) (v (list (uri-scheme u)  (uri-userinfo u)  (uri-host u)  (uri-port u) (uri-path u)  (uri-query u)  (uri-fragment u))))
  (if (equal v ,r)
